        ...
        <section className="project" id="about-project">
            ...
            <div className="project__grid">
                <div className="project__table">
                    ...
                    <p className="project__text project__text_size_small">Составление плана, работу над бэкендом, вёрстку, добавление функциональности и финальные доработки.</p>
                </div>
                <div className="project__table">
                    <p className="project__text">На выполнение диплома ушло 5 недель</p>
                    <p className="project__text project__text_size_small">У каждого этапа был мягкий и жёсткий дедлайн, которые нужно было соблюдать, чтобы успешно защититься.</p>
                </div>
            </div>
